...
public class ObjectPractice {
	...
	public static void main(String[] args) {
		...
		Weather estonia = new Weather("Estonia", new int[] { -3, 0, 6, 3, 6, 7, 8 });
		Weather norway = new Weather("Norway", new int[] { -11, 10, 9, 9, 7, -2, 6 });
		
		Weather latvia = new Weather("Latvia", new int[] { -1, 0, 5, 2, 6, -1, 0 });
		System.out.println(latvia.getCountry() + " " + Arrays.toString(latvia.getDaysWeather()));
		System.out.println(latvia);
		System.out.println("Average temperature in Riga will be " + latvia.getWeekAverage());
		System.out.println("Highest temperature in Riga will be " + latvia.getHottestTemperature());
		System.out.println("Lowest temperature in Riga will be" +latvia.getColdestTemperature()); 
		System.out.println("Hottest day in Riga will be " + latvia.getHottestDay());
		System.out.println("Hottest day in Riga will be " + latvia.getHottestDay2());
		...
		// Task - We should be able to create a new object of class Weather by
		// passing
		// both field values.
		// Create constructor in Weather class
		// public Weather(String country , int[] daysWeater)

		// Task - We should prohibit to reassign country field value for weather
		// objects
		// Make it final

		// Task - Lets create few weather forecasts for following countries:
		// Latvia,
		// Antaliya, Bergen
		// Example:
		...
		// Task - User should be able to get weather information in
		// user-friendly way
		...
		// Task - I want to be able to convert Celsius temperature into
		// Fahrenheit
		...
		// Task - We need that some one would provide to us weather forecast for
		// specific country
		...
		// Task - I as a worker of weather forecast center want to be able to
		// overview and interact with weather forecasts
		...
		// Extra Task - Represent day temperature by dayMax and dayMin, same for
		// wind
