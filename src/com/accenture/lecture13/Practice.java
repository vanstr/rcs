...
public class Practice {
	...
	public static void main(String[] args) {
		...
		// You should get printed out into console: Maximum is 18
	...
	public static void printArray(int[] someArray) {
		...
		for (int item : someArray) {
			System.out.println(i + " element is  " + item);
			i++;
		}
	...
	public static double getAvaregeDouble(int[] someArray) {
		return getSum(someArray) / (double)someArray.length;
	}
	...
	public static void createArray() {
		...
		System.out.println("How big array to create ?");
		int size = scanner.nextInt();
		int[] newArray1 = new int[size];
		newArray1 = getArrayDefinedByUser(size);
